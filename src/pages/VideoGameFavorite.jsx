...
const VideoGameFavorite = () => {
    ...
    const { favoriteVideoGames, compare, setCompare } = useContext(GlobalContext);
    ...
    }, [favoriteVideoGames, sortBy, query, selectedCategory])
    return (
        <>
                    ...
                    <div className="search-filter">
                        ...
                        <div className='category-filter'>
                            ...
                            <select value={selectedCategory} onChange={e => setSelectedCategory(e.target.value)}>
                                ...
                                {
                                    filteredAndSortedVideoGames && filteredAndSortedVideoGames.filter((game, index, self) =>
